...
namespace Lun.SFML.Graphics
{
    ...
    public abstract class Shape : Transformable, Drawable
    {
        ...
        {
            get { return (Rectangle)sfShape_getTextureRect(CPointer); }
        ...
        {
            return (Rectangle)sfShape_getLocalBounds(CPointer);
        }
        ...
        public Rectangle GetGlobalBounds()
        {
            ...
            return (Rectangle)Transform.TransformRect(GetLocalBounds());
        }
