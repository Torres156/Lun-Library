...
namespace Lun.SFML.Graphics
{
    ...
    public class Sprite : Transformable, Drawable
    {
        ...
        public Texture Texture
        {
            ...
            set { if (myTexture != value) { myTexture = value; sfSprite_setTexture(CPointer, value != null ? value.CPointer : IntPtr.Zero, false); } }
        }
        ...
        {
            sfSprite_setTexture(CPointer, IntPtr.Zero, false);
