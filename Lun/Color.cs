...
namespace Lun
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        public static readonly Color CornflowerBlue = new Color(System.Drawing.Color.CornflowerBlue);

        public static implicit operator SFML.Graphics.Color(Color v)
            => new SFML.Graphics.Color(v.R, v.G, v.B, v.A);

        public static explicit operator Color(SFML.Graphics.Color v)
        ...
        public static explicit operator Color(System.Drawing.Color v)
            => new Color(v.R, v.G, v.B, v.A);
    }
}
